...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        String result = Solution.maxLengthOfPalindromicSubstring(str);
        System.out.println("Solution.maxLengthOfPalindromicSubstring(" + array.toString() + ") is " + result);
    }
}
